...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "expressiveFastSpatial", style = "slidefade" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3, bezier = "emphasizedAccel", style = "popin 60%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 4, bezier = "menu_decel", style = "slidevert" })
